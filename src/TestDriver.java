...
public class TestDriver {
	...
	public static void main(String[] args) {
		...
		PizzaVO baconPizza = new PizzaVO("Bacon", new String[] {"bacon", "cheese"}, 8.0f);
		...
		for(var i=0; i < 10; i++) {
			myFirstOrder.addDish(baconPizza);
		}
		...
		OrderVO mySecondOrder = new OrderVO(LocalDateTime.of(2019, 4, 9, 11, 7), tim);
		mySecondOrder.setTimestampDeliveredOrder(LocalDateTime.of(2019, 4, 9, 12, 7));
		
		for(var i=0; i < 10; i++) {
			mySecondOrder.addDish(baconPizza);
		}

		System.out.println(mySecondOrder.toString());
		System.out.println();
	}
}
